...
class Singer extends React.Component {
            ...
            <TableBody>
              {this.state.detail.hotSongs.map((row, index) => (
                ...
                >
                  ...
                  <TableCell>
                    {row.ar.length > 1
                      ? row.ar[0].name + "/" + row.ar[1].name
                      : row.ar[0].name}
                  </TableCell>
                  <TableCell
                    onClick={this.handleSelectAlbum.bind(this, row.al.id)}
          ...
          <Table style={{ width: "95%" }}>
            ...
            <TableBody>
              {this.state.albums.map((item, index) => {
                ...
                } else pic = item.blurPicUrl + "?param=100y100";
                let alias = null;
                ...
                return (
                  <TableRow
                    key={item.id}
                    onDoubleClick={this.handleSelectAlbum.bind(this, item.id)}
                    hover={true}
                  >
                    <TableCell>
                      {index < 9 ? "0" + (index + 1) : index + 1}
        ...
        {this.state.mvs.map(function (item, index) {
          return (
            <div
              ...
              key={index}
              onClick={that.handleSelectMV.bind(that, item.id)}
            >
              <img
                src={item.imgurl + "?param=180y100"}
                alt="pic"
                style={{ borderRadius: "10px" }}
              />
  ...
  listview() {
    switch (this.state.currentIndex) {
      ...
      case "1":
        return this.singerAlbum();
      case "2":
        return this.singerMV();
      case "3":
        return this.singerInfo();
      case "4":
        return this.simiSinger();
      default:
        return null;
    }
  }
  ...
  describe() {
    ...
    } else des = this.state.detail.artist.briefDesc;
    return des;
  }
      ...
      <div className={style.main}>
        {this.state.loading_top ? (
          ...
          <div className={style.top}>
            ...
            <div>
              <div
                style={{ marginLeft: "20px", width: "700px", height: "225px" }}
              >
                <div>
                  <div
                    style={{
