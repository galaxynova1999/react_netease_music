...
class userPlayListState {
  @observable userLikePlayListID = localStorage.getItem("userLikePlayListID");
  @observable playList = JSON.parse(localStorage.getItem("playList"));
  @observable subscribedPlayList = JSON.parse(
    localStorage.getItem("subscribedPlayList")
  );
