  ...
  return (
    <div>
      <ThemeProvider theme={theme}>
        <Tabs indicatorColor="secondary" textColor="secondary" value={cat}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" scope="row">
                        <img
                          src={createPicURL(item.album.picUrl, 80, 80)}
                          alt="pic"
        ...
        data.map(function (item, index) {
          return (
            ...
            >
              <div>
                <img
                  src={createPicURL(item.picUrl, 120, 120)}
...
class Latest extends React.Component {
  ...
  render() {
    return (
      <div>
        <div
          style={{ marginLeft: "40%", marginTop: "20px", marginBottom: "20px" }}
        >
          <ThemeProvider theme={theme}>
            <ButtonGroup>
              <Button
                variant={
                  this.state.selected === "song" ? "contained" : "outlined"
                }
              ...
              <Button
                variant={
                  this.state.selected === "album" ? "contained" : "outlined"
                }
        ...
        <div style={{ marginLeft: "10%" }}>{this.listview()}</div>
      </div>
    );
  }
}
