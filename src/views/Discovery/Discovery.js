          ...
          <ThemeProvider theme={theme}>
            ...
            >
              <Tab
                label="个性推荐"
                value="0"
                onClick={this.handleRoute.bind(this, "/recommend", "0")}
              />
              <Tab
                label="歌单"
                value="1"
                onClick={this.handleRoute.bind(this, "/musicmenu", "1")}
              />
              <Tab
                label="排行榜"
                value="2"
                onClick={this.handleRoute.bind(this, "/leaderboard", "2")}
              />
              <Tab
                label="歌手"
                value="3"
                onClick={this.handleRoute.bind(this, "/singer", "3")}
              />
              <Tab
                label="最新音乐"
                value="4"
                onClick={this.handleRoute.bind(this, "/latest", "4")}
              />
            </Tabs>
          </ThemeProvider>
        </div>
