...
import {
  ...
  getNextSong,
  getPrevSong,
} from "../../api/local/localPlayRecord";
...
class MyFooter extends React.Component {
  ...
  componentWillUnmount() {
    ...
    this.player.removeEventListener(
      "timeupdate",
      this.timeUpdateListener.bind(this)
    );
    this.player.removeEventListener(
      "durationchange",
      this.songChange.bind(this)
    );
  }
  timeUpdateListener() {
    let timeDisplay;
  ...
  initPlayer() {
    ...
    if (player) {
      ...
      player.addEventListener(
        "timeupdate",
        throttle(this.timeUpdateListener.bind(this), 1000)
      );
  ...
  render() {
    ...
    } else playButton = <PauseCircleFilledIcon style={{ fontSize: 50 }} />;
          ...
          <div className={style.main}>
            ...
            <div className={style.progress}>
              ...
              <PrettoSlider
                ...
                onChangeCommitted={this.handlePlayProgressChangeCommitted.bind(
                  this
                )}
                style={{ marginLeft: "20px" }}
              />
