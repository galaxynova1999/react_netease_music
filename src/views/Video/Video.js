    ...
    const Simi = this.state.simi.map((item, index) => {
      let author = () => {
        if (this.props.match.params.type === "video") {
          return (
            "by " +
            item.creator.map(function (item, index, arr) {
          ...
          return (
            "by " +
            item.artists.map(function (item, index, arr) {
              if (index === arr.length - 1) {
                return item.name;
              } else {
                return item.name + "/";
      ...
      return (
        <div
          ...
          key={index}
          onClick={this.handleSimi.bind(this, item.id || item.vid)}
        >
          <div>
            <img
              alt="avatar"
          ...
          <div style={{ marginLeft: "10px", fontSize: "16px" }}>
            ...
            <br />
            <span style={{ fontSize: "0.9em", color: "rgb(136,136,136)" }}>
              {formatSongDuration(
                this.props.match.params.type === "video"
                  ? item.durationms
                  : item.duration
      ...
      <div style={{ display: "flex" }}>
        <div style={{ flexShrink: "1" }}>
          {this.state.loadingVideo ? (
            ...
            <div
              style={{ width: "45vw", paddingTop: "20px", paddingLeft: "40px" }}
            >
              <span
                style={{
                  fontSize: "20px",
              ...
              >
                {this.state.video.artistName ||
                  "by " + this.state.video.creator.nickname}
              </span>
          ...
          <div
            style={{ marginTop: "70px", paddingLeft: "40px", width: "45vw" }}
          >
            <p
              style={{
                fontSize: "20px",
        ...
        <div style={{ flexBasis: "15vw", flexGrow: "1", padding: "40px" }}>
          <div style={{ paddingLeft: "20px" }}>
            <p style={{ fontSize: "20px" }}>
              {this.props.match.params.type === "video" ? "视频" : "MV"}介绍
            </p>
            <Divider />
            <p style={{ color: "#bababa", marginTop: "5px" }}>
              <span style={{ fontSize: "15px" }}>
                发布时间:
                {moment(this.state.video.publishTime).format("YYYY-MM-DD")}
              </span>
